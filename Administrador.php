...
<table width="98%" border="0">
          ...
          <ul class="nav" role="navigation">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
                <li role="presentation"><a role="menuitem" tabindex="-1" href="registros.php" target="admin"><i class="icon-user"></i> Nuevo Usuario</a></li>
                ...
                <li role="presentation"><a role="menuitem" tabindex="-1" href="reg_facturas.php" target="admin"><i class="icon-folder-open"></i> Facturas</a></li>
  ...
  <tr>
    <td><iframe src="inicio.php" frameborder="0" scrolling="yes" name="admin" width="100%" height="750"></iframe></td>
  </tr>
  <tr>
    <td>
    <pre><center><strong><a href="https://www.facebook.com/soft.unicorn" target="_blank" style="color:#000" style="background-color:#EEE">Desarrollado por Hernan Chaparro 2016 - Venezuela</a></strong></center></pre>
    </td>
  </tr>
</table>
</body>
